...
if __name__ == '__main__':
    ...
    if multi_gpu and not LOAD_MODEL:
...
###------------------display generated samples--------------------------------------------------      
        decode_images = generate_image(netG, dim=SIZE, channel=3, batch_size=num_samples, noise=real_img)
        ...
        if write_logs:
            utils.save_image(decode_images, str(decoded_path  +'/' + 'decoded_{}.png').format(epoch), nrow=int(sqrt(1)), padding=2)
