...
from model import Generator28, ML28
...
parser.add_argument('--g_model_name', default='Generator28', type=str, help='generator model name')
...
###------------------display generated samples--------------------------------------------------      
        ...
        fixed_noise1 = gen_rand_noise_MNIST(1).to(DEVICE)        
        gen_image1 = generate_image(netG, dim=SIZE, channel=1, batch_size=1, noise=fixed_noise1)
