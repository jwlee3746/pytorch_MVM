...
from model import Generator28_linear, Generator64, Generator128, ML28, ML64, ML128, gen64_DCGAN, ML64_DCGAN
...
if __name__ == '__main__':
    ...
    ### Generator ###
    channel = 1
    netG = eval(opt.g_model_name+'(l_dim={}, channel={})'.format(opt.noise_dim, channel))
...
###--------------------Save Embeddings----------------------------------------        
        ...
        writer2.add_embedding(noise_embedding[:opt.n_to_show],
                    global_step=epoch,
                    tag='noise')
