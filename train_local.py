...
from loss import TripletLoss, pairwise_distances, AveragedHausdorffLoss, cosLoss
...
# DATA
parser.add_argument('--data_path', default='D:\datasets/', type=str, help='dataset path')
#parser.add_argument('--data_path', default='/root/', type=str, help='dataset path')
...
parser.add_argument('--ep', default=80, type=int, help='train epoch number')
parser.add_argument('--num_samples', default=121, type=int, help='number of displayed samples')
...
# EMBEDDINGS
parser.add_argument('--n_to_show', default=1000, type=int, help='Num of fixed latent vector to show embeddings')
...
if __name__ == '__main__':
    ...
    copy('train_local.py', code_path+'/train_local.py')
    args_dict = vars(opt)
